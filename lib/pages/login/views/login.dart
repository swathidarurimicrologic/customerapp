...
class Login extends GetView<LoginController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CommonAppBar(
        titleWidget: const Text(CoreAppConstants.loginLbl),
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      //username
                      Text(
                        CoreAppConstants.welcomeLbl,
                        style: Get.textTheme.headlineMedium,
                      ),
                      const SizedBox(height: 10),
                      const Text(
                        CoreAppConstants.signUpText,
                        style: TextStyle(
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            flex: 1,
                            child: InkWell(
                              onTap: () => Get.toNamed(Routes.CONTACT_DETAILS),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                            ...
                            child: Obx(
                              () => Container(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text(CoreAppConstants.phoneNumberLbl),
                                    const SizedBox(height: 5),
                                    CommonTextField(
                                      controller:
                                      ...
                                      hintText: CoreAppConstants.phoneNumberLbl,
                                      prefixIconData: null,
