...
class BuyWashCheckoutWidget extends StatefulWidget {
  const BuyWashCheckoutWidget({super.key});

  @override
  State<BuyWashCheckoutWidget> createState() => _BuyWashCheckoutWidgetState();
}

class _BuyWashCheckoutWidgetState extends State<BuyWashCheckoutWidget> {
            ...
            children: [
              Obx(
                () => CommonButton(
                  ...
                  text:
                      '${CoreAppConstants.payLbl}\$${controller.finalAmount.toStringAsFixed(2)}',
                ),
              ),
        ...
        widgetBody: Container(
          ...
          child: ListView(
            children: [
              ...
              Text(CoreAppConstants.startWashNowLbl,
                  textAlign: TextAlign.center,
                  style: Get.textTheme.titleMedium),
              const SizedBox(height: 15),
              CommonButton(
                    ...
                    CommonAlertDialog().successAlert(
                        ...
                        onPressed: () {
                          CommonAlertDialog().positiveNegativeAlert(
                              ...
                              positiveButtonText:
                                  CoreAppConstants.gotoWashesLbl,
              ...
              InkWell(
                ...
                child: Container(
                  alignment: Alignment.center,
                  child: Text(CoreAppConstants.saveLaterLbl,
                      style: Get.textTheme.bodyMedium!
